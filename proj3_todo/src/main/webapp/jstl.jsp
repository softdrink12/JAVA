...
아무${ a4 }글씨<br>
	...
	<hr>
	<a href="https://search.naver.com/search.naver?where=nexearch&sm=top_hty&fbm=0&ie=utf8&query=검색" target="_blank">네이버검색</a>
	<br>
	<a href="http://127.0.0.1:8080/proj3_todo/jstl.jsp">jstl page</a>
	<br>
	<a href="/proj3_todo/jstl.jsp">jstl page</a>
	<br>
	...
	2. context path 자동추가 (/proj3_todo)<br>
